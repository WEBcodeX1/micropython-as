...
> [!NOTE]
> The C++ POSIX Thread Wrapper Library runs perfectly on the ESP-IDF platform. The LED fading control has been
> implemented using the POSIX thread API. Additionally, because RISC-V 32-bit and Xtensa 32-bit chipsets execute
> atomic reads and writes of 32-bit variables, using a thread::lock is unnecessary for simple, unprotected
