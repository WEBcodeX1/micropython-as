...
// Original font from: https://opengameart.org/content/8x8-ascii-bitmap-font-with-c-source

static uint8_t font8x8_basic_tr[128][8] = {
    { 0x00, 0x00, 0x00, 0x80, 0x80, 0x00, 0x00, 0x00 },   // U+0000 (WiFi 1 bar)
    { 0x00, 0x00, 0x40, 0xA0, 0xA0, 0x40, 0x00, 0x00 },   // U+0001 (WiFi 2 bars)
    { 0x00, 0x10, 0x48, 0xA8, 0xA8, 0x48, 0x10, 0x00 },   // U+0002 (WiFi 3 bars)
    { 0x04, 0x12, 0x4A, 0xAA, 0xAA, 0x4A, 0x12, 0x04 },   // U+0003 (WiFi 4 bars)
    { 0x00, 0x06, 0x4E, 0x7C, 0x7C, 0x4E, 0x06, 0x00 },   // U+0004 (cup)
