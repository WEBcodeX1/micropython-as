...
{
    //ESP_LOGI("TitleScreen", "PlayerCount:%d", PlayerCount);
    ...
    if (PlayerCount == 0) {
        ...
        renderText(7, BaseString.append(WifiCharIndex, 1));
    }
    else if (PlayerCount == 2) {
        char WifiCharIndex[1] = { 3 };
        string BaseStringPre = "P1:";
        string BaseStringPost = "        P2:";
        string RenderString = BaseStringPre.append(WifiCharIndex, 1).append(BaseStringPost).append(WifiCharIndex, 1);
